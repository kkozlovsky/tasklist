...
import ru.kerporation.tasklist.service.impl.*;
...
import ru.kerporation.tasklist.web.security.JwtUserDetailsService;
...
public class TestConfig {
    ...
    public MinioProperties minioProperties() {
        final MinioProperties properties = new MinioProperties();
    ...
    public JwtTokenProvider tokenProvider(final UserRepository userRepository) {
        return new JwtTokenProvider(jwtProperties(), userDetailsService(userRepository), userService(userRepository));
    }
    ...
    public AuthServiceImpl authService(final UserRepository userRepository,
        ...
        return new AuthServiceImpl(userService(userRepository), authenticationManager, tokenProvider(userRepository));
    }
